...
const stopWordsEnList = ["a", "about", "above", "after", "again", "against", "all",
...
const isStopWord = (word, stopWordsList) => {
  const stopWordsTrie = new Trie();
  stopWordsTrie.addStrings(stopWordsList);
  return stopWordsTrie.contains(word.toLowerCase());
};
